...
class GSinfo2DB(Spider):
    ...
    def __init__(self, thcnt):
        ...
        self.fail_file = FileSaver("fail2db_qycxb.txt")
        self.sus_file = FileSaver("SZ2DB_qycxb.txt")
    ...
    def init_filter(self):
        with open("SZ2DB_qycxb.txt") as f:
            cnt = 0
            for line in f:
                line = line.strip()
    ...
    def dispatch(self):
        files = ["./qiyecxb-ct/beijing_query_detail1.txt"]
        for fl in files:
            with open(fl) as f:
                for line in f:
                    line = line.strip()
