...
def run_fun2(ac):
    runner = FullJobRunner(
        gen_jobs_params(ac['accounts'], ac['name'], ac['prefix'], spec=False, detail=True, school=False,
...
def run_fun_spec(ac):
    runner = FullJobRunner(
        gen_jobs_params(ac['accounts'], ac['name'], ac['prefix'], spec=True, detail=False, school=False,
                        spec_parser=False, detail_parser=False, spec_r=True,
                        sch_parser=False))
    runner.run()
...
if __name__ == '__main__':
    ...
    # runner = FullJobRunner(
    #     gen_jobs_params([a.gen_run_param()], name, provinces[name], spec=True, detail=False, school=False,
    ...
    for a in acs:
        ...
        i += 1
    runner = FullJobRunner(
        gen_jobs_params(ac['accounts'], name, provinces[name], spec=False, detail=True, school=False,
                        spec_parser=False, detail_parser=False, spec_r=False,detail_r=False,
                        sch_parser=False))
    runner.run()
