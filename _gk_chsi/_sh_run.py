...
# !/usr/bin/env python
# -*- coding:utf8 -*-
from runner import run_full_jobs, run_spec_jobs
...
if __name__ == '__main__':
    ...
    # ]
    # accounts = [
    #     {'username': 'nm2016e0', 'proxy': '101.226.249.237:80', 'password': 'shi2026cxs', 'ua': ua[1]},
    #     # {'username': 'nm2016e2', 'proxy': '106.75.134.191:18888:ipin:ipin1234', 'password': 'shi2026cxs',
    #     #  'ua': ua[3]},
    #     # {'username': 'nm2016e3', 'proxy': '106.75.134.192:18888:ipin:ipin1234', 'password': 'shi2026cxs',
    #     #  'ua': ua[4]},
    #     # {'username': 'nm2016e4', 'proxy': '106.75.134.189:18888:ipin:ipin1234', 'password': 'shi2026cxs',
    #     #  'ua': ua[2]},
    #     # {'username': 'nm2016e1', 'proxy': '101.226.249.237:80', 'password': 'shi2026cxs', 'ua': ua[5]},
    # ]
    #
    # # accounts = [
    ...
    # run_spec_jobs(accounts, u'内蒙古', 'nm')
    accounts = [
        {'username': 'bj2016e0', 'proxy': '106.75.134.192:18888:ipin:ipin1234', 'password': 'shi2026cxs', 'ua': ua[1]},
        # {'username': 'nm2016e2', 'proxy': '106.75.134.191:18888:ipin:ipin1234', 'password': 'shi2026cxs',
        #  'ua': ua[3]},
        # {'username': 'nm2016e3', 'proxy': '106.75.134.192:18888:ipin:ipin1234', 'password': 'shi2026cxs',
        #  'ua': ua[4]},
    ...
    # ]
    # print FullJobRunner.fetch_remain_time(jobs[0])
    run_spec_jobs(accounts, u'北京', 'bj')
